<?php
core\Core::getInstance()->pageParams['title'] = 'Редагування новини';
/** @var array $news*/
    ...
    <main>
        <form method="post" action="" enctype="multipart/form-data">
            <p style="text-align: center"><img src="../../themes/light/images/guitarBlack.png" width="100" height="100"
                                               alt="kkk"></p>
            <h1 class="h3 mb-3 fw-normal text-center"><b>Редагування новини</b></h1>
            ...
            <div class="form-floating">
                ...
                <input type="text" class="form-control w-100" name="News_name" id="News_name"
                       placeholder="name@example.com" value="<?= $news['News_name']; ?>">
            ...
            <div class="form-floating">
                <textarea class="ckeditor" name="short_discription" id="short_discription"
                          style="width: 1295px; height: 300px"><?= $news['short_discription']; ?></textarea>
            ...
            <div class="form-floating w-100">
                <textarea class="ckeditor" name="News_text_content" id="News_text_content"
                          style="width: 1295px; height: 300px"><?= $news['News_text_content']; ?></textarea>
            </div>
            <hr>
